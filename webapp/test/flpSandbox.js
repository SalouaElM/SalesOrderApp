		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#apsalesorderapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apsalesorderapp-display": {
								"semanticObject": "apsalesorderapp",
								"action": "display",
								"description": "A Fiori application for sales orders.",
								"title": "Sales Order App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.salesorderapp",
									"url": sap.ui.require.toUrl("ap/salesorderapp")
								}
							}
						}
					}
